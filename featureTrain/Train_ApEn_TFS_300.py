...
def ComponentApEn(signal, recTime, m, x, windowSize=200, sampleFrequency=20, minFrequency=0, maxFrequency=4):
    """
        ComponentApEn(signal, recTime, m, x,, windowSize=200, sampleFrequency=20, minFrequency=0, maxFrequency=4)
